define(['services/dataservice', 'config', 'services/tokenstore'], function (dataservice, config, tokenStore) {
    ...
    var btnSearch = function (obj, e) {
        ...
        if ($('#itemAddForm').valid()) {
            ...
            dataservice.getItemsBalanceBrand(invoiceToAdd).done(function (data) {
    ...
    var PrintToExcel = function () {
        ...
        config.itemsColumnDefenition.name = "تقرير جرد براند بالكميات فقط";

        config.itemsColumnDefenition.widths = ['30%', '20%', '10%', '20%'];
        ...
        config.itemsColumnDefenition.fields = ['description', 'resourceCode', 'quantity', 'categoryName'];
