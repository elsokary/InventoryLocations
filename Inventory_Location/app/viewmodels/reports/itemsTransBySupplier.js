define(['plugins/router', 'services/dataservice', 'config', 'services/tokenstore'], function (router, dataservice, config, tokenStore) {
    ...
    var PrintToExcel = function () {
        ...
        config.itemsColumnDefenition.name = config.language.itemsTransBySupplier[config.currentLanguage()];

        config.itemsColumnDefenition.widths = ['15%', '15%', '5%', '7%', '5%', '5%', '5%', '7%', '8%'];
        ...
        config.itemsColumnDefenition.friendlyNames = [
                                             ...
                                             , config.language.importQnty[config.currentLanguage()]
                                             , config.language.excuteQnty[config.currentLanguage()]
        ...
        config.itemsColumnDefenition.fields = ['description', 'resourceCode', 'importQnty', 'executeQnty', 'credit', 'cost', 'price', 'totalCost', 'totalPrice'];
