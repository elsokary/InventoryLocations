    ...
    init: function (tableElement, valueAccessor, allBindings, viewModel) {
        ...
        */
                ...
                if (clickedRow && clickedRow.length >= 0) {
                    ...
                    if (clickedNode) {
                        ...
                        if ((!clickTarget.closest("thead").length &&
                            ...
                            !clickTarget.closest(".checkbox").length)) {
                            ...
                            clickTarget.popover({ trigger: "manual", container: tdId, placement: "top", html: true, content: "<div class=\"btn-group\" style=\"width: 67px;\"><a class=\"btn btn-sm btn-danger confirm-yes\" data-dismiss=\"confirmation\" href=\"javascript:void(0);\" target=\"_self\"><i class=\"glyphicon glyphicon-ok\"></i></a><a class=\"btn btn-default btn-sm confirm-no\" data-dismiss=\"confirmation\"><i class=\"glyphicon glyphicon-remove\"></i></a></div>" }).popover("show");
        ...
        $.each(table.find(".ko-table-pagination"), function (i, o) {
            $(o).html("<span class=\"text-muted pull-left\" style=\"height:34px; line-height:34px; margin-right: 5px; margin-top: 5px;\" data-bind=\"if: !koTable.hasRows()\">لا يوجد اي بيانات للعرض الان |</span><ul class=\"pagination pull-left\" data-bind=\"if: koTable.paginationRequired()\" style=\"padding: 0 !important; margin: 5px 5px 5px 0 !important;\" >" +
                    ...
                    "</ul><div class=\"text-muted pull-left\" style=\"height:34px; line-height:34px; margin-right: 5px; margin-top: 5px;\" data-bind=\"visable: koTable.rowCount(), text: 'عدد الصفوف: ' + koTable.rowCount()\"></div>")
        ...
        if (showSearch) {
            ...
            koSearch.html("<span class=\"glyphicon glyphicon-search input-group-addon input-group-sm\" style=\"top: 0;\"></span>" +
                "<input type=\"text\" class=\"form-control\" placeholder=\"ابحث...\" value=\"\" />");
