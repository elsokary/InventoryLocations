...
(function (window) {
    ...
    ***********************************************/
    window.kg.defaultGridTemplate = function () { return '<div data-bind="css: {\'ui-widget\': jqueryUITheme, \'kgNoSelect\' : disableTextSelection}"><div class="kgTopPanel" data-bind="css: {\'ui-widget-header\':jqueryUITheme, \'ui-corner-top\': jqueryUITheme}, style: $data.topPanelStyle"><div class="kgGroupPanel" data-bind="visible: $data.showGroupPanel, style: headerStyle"><div class="kgGroupPanelDescription" data-bind="visible: configGroups().length == 0"><span style="padding-left: 5px; padding-right: 5px;" data-bind="text: titleOfGroupingArea"></span></div><ul data-bind="visible: configGroups().length > 0, foreach: configGroups" class="kgGroupList"><li class="kgGroupItem"><span class="kgGroupElement"><div class="kgGroupName"><span data-bind="text: displayName"></span><span data-bind="click: function(data) { $root.removeGroup($index()) }" class="kgRemoveGroup">x</span></div><span data-bind="visible: $index() < ($root.configGroups().length - 1)" class="kgGroupArrow"></span></span></li></ul></div><div class="kgHeaderContainer" data-bind="style: headerStyle"><div class="kgHeaderScroller" data-bind="style: headerScrollerStyle, kgHeaderRow: $data" ></div></div><div class="kgHeaderButton" data-bind="visible: ($data.showColumnMenu || $data.showFilter), click: toggleShowMenu, css: { ar: isAr, en: !isAr() }"><div class="kgHeaderButtonArrow"></div></div><div data-bind="visible: showMenu, css: { ar: isAr, en: !isAr() }" class="kgColMenu" style="background-color: #f2f2f2; border: 2px solid #ddd;"><div data-bind="visible: showFilter"><input placeholder="Seach Field:Value" type="text" data-bind="value: filterText, valueUpdate: \'afterkeydown\'"/></div><div data-bind="visible: showColumnMenu"><span class="kgMenuText">Choose Columns:</span><ul class="kgColList" data-bind="foreach: nonAggColumns"><li class="kgColListItem"><label style="position: relative;"><input type="checkbox" class="kgColListCheckbox" data-bind="checked: visible"/><span data-bind="text: displayName, click: toggleVisible"></span><a title="Group By" data-bind="attr: {\'class\': groupedByClass }, visible: (field != \'\u2714\'), click: $parent.groupBy"></a><span class="kgGroupingNumber" data-bind="visible: groupIndex() > 0, text: groupIndex"></span></label></li></ul></div></div></div><div class="kgViewport" data-bind="css: {\'ui-widget-content\': jqueryUITheme }, style: viewportStyle"><div data-bind="visible: gridLoadStatus(), text: gridLoadStatus" style="font-size: 15px; font-weight: 700; text-align: center; margin-top: 12%;"></div><div class="kgCanvas" data-bind="style: canvasStyle"><div data-bind="foreach: renderedRows" style="position: absolute;"><div data-bind="style: { \'top\': offsetTop, \'height\': $parent.rowHeight + \'px\' }, click: toggleSelected, css: {\'selected\': selected, \'even\': isEven , \'odd\': isOdd, \'ui-state-default\': $parent.jqueryUITheme && isOdd, \'ui-state-active\':$parent.jqueryUITheme && isEven}, kgRow: $data" class="kgRow"></div></div></div></div><div class="kgFooterPanel" data-bind="css: {\'ui-widget-content\': jqueryUITheme, \'ui-corner-bottom\': jqueryUITheme}, style: footerStyle"><div class="kgTotalSelectContainer" data-bind="visible: footerVisible"><div class="kgFooterTotalItems" style="display: inline-block;" data-bind="css: {\'kgNoMultiSelect\': !multiSelect}" ><span class="kgLabel" data-bind="text: totalItems"><span data-bind="text: maxRowsDisplay"></span></span><span data-bind="visible: filterText().length > 0" class="kgLabel">(Showing: <span data-bind="text: totalFilteredItemsLength"></span>)</span></div><div class="btn-group" role="group"><button type="button" data-bind="click: loadMoreData" class="btn btn-xs btn-default"><i class="fa fa-download"></i></button><div data-bind="css: { hidden: !isLoadingMoreData() }" style="margin-left: 25px; "><span style="margin-left: 5px;">Loading</span><i style="margin-left: 8px; margin-top: 5px; color: darkcyan" class="fa fa-refresh fa-spin"></i></div></div><div class="kgFooterSelectedItems" data-bind="visible: multiSelect"><span class="kgLabel">Selected Items: <span data-bind="text: selectedItemCount"></span></span></div></div><div class="kgPagerContainer" style="float: right; margin-top: 5px; padding-right: 40px;" data-bind="visible: (footerVisible && enablePaging), css: {\'kgNoMultiSelect\': !multiSelect}"><div style="float:left; margin-right: 10px;" class="kgRowCountPicker"><span style="float: left; margin-top: 3px; margin-right: 5px;" class="kgLabel" data-bind="text: pageSizeText"></span><select style="float: left;height: 27px; width: 50px;border: 1px solid #ddd;border-radius: 3px;" data-bind="value: pagingOptions.pageSize, options: pagingOptions.pageSizes"></select></div><div style="float:left; margin-right: 10px; line-height:25px;" class="kgPagerControl" style="float: left; min-width: 135px;"><div class="btn-group"><button class="btn btn-default" style="height: 28px; padding: 4px 12px;" data-bind="click: pageToFirst, disable: cantPageBackward()" title="First Page"><i class="fa fa-angle-double-left"></i></button><button class="btn btn-default" style="height: 28px; padding: 4px 12px;" data-bind="click: pageBackward, disable: cantPageBackward()" title="Previous Page"><i class="fa fa-angle-left"></i></button></div><input class="kgPagerCurrent" type="number" style="width:50px; height: 28px; margin-top: 0px; padding: 0px 4px; border: 1px solid #ddd; border-left: none; border-right: none;" data-bind="value: pagingOptions.currentPage, valueUpdate: \'afterkeydown\'"/><div class="btn-group"><button class="btn btn-default" style="height: 28px; padding: 4px 12px;" data-bind="click: pageForward, disable: cantPageForward()" title="Next Page"><i class="fa fa-angle-right"></i></button><button class="btn btn-default" style="height: 28px; padding: 4px 12px;" data-bind="click: pageToLast, disable: cantPageForward()" title="Last Page"><i class="fa fa-angle-double-right"></i></button></div></div></div></div></div>'; };
    ...
    ko.bindingHandlers['koGrid'] = (function () {
        return {
            'init': function (element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
                ...
                grid.$userViewModelRoot = bindingContext.$parent;
        ...
        return {
            'init': function (element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
                ...
                var compile = function (html) {
                    ...
                    row.$userViewModelRoot = bindingContext.$parent.$userViewModelRoot;
    ...
    ***********************************************/
    window.kg.Column = function (config, grid) {
        ...
        self.filterType = colDef.filterType;
        ...
        if (ko.isObservable(colDef.visible)) {
            colDef.visible(colDef.visible() || false);
            self._visible = colDef.visible;
        } else {
    ...
    ***********************************************/
    window.kg.RowFactory = function (grid) {
        ...
        self.buildEntityRow = function (entity, rowIndex) {
            ...
            if (!row) {
                // build the row
                row = new window.kg.Row(entity, self.rowConfig, self.selectionService, grid.config);
    ...
    ***********************************************/
    window.kg.Grid = function (options) {
        var defaults = {
            ...
            showColumnMenu: true,
            showFilter: true,
            titleOfGroupingArea: ko.observable(""),
        ...
        self.titleOfGroupingArea = self.config.titleOfGroupingArea;
        self.filteredData = ko.observableArray([]);
        self.lastSortedColumn = undefined;
        self.showFilter = self.config.showFilter;
        self.pageSizeText = self.config.language.pageSize[self.config.currentLanguage()];
        self.filterText = self.config.filterOptions.filterText;
        self.isAr = (self.config.currentLanguage() === "ar") ? ko.observable(true) : ko.observable(false);
        self.totalItems = (self.config.currentLanguage() === "ar") ? "عدد الصفوف:" : "Total Items:";
        ...
        self.isLoadingData = options.isLoadingData;
        self.gridLoadStatus = options.gridLoadStatus;
    ...
    ***********************************************/
    window.kg.Row = function (entity, config, selectionService, gridOptions) {
        ...
        self.isChecked.subscribe(function (value) {
            if (value && (gridOptions.columnDefs[0].checkedRows.indexOf(self.entity.id) < 0)) {
                gridOptions.columnDefs[0].checkedRows.push(self.entity.id);
            } else if (!value) {
                gridOptions.columnDefs[0].checkedRows.remove(self.entity.id);
            }
        });

        if (gridOptions.columnDefs[0].gridCheckBoxes) {
            gridOptions.columnDefs[0].gridCheckBoxes.push(self.isChecked);
        }
    ...
    window.kg.SearchProvider = function (grid) {
        ...
        self.evalFilter = function () {
            if (searchConditions.length === 0) {
                if (typeof grid.sortedData.peek() === "function") {
