define(['config', 'plugins/router', 'services/tokenstore'], function (config, router, tokenStore) {
    var vm = {};
    ...
    vm.activate = function () {
        ...
        //          { "moduleId": "viewmodels/summaries/AlertOnItemsCostGreaterPrice", "column": "left" }, 
        //          { "moduleId": "viewmodels/summaries/getPaymentBarChartComparisonYearly", "column": "left" },
        //          { "moduleId": "viewmodels/summaries/alertItemsChangePrices", "column": "right" },
        //          { "moduleId": "viewmodels/summaries/alertOnItemsNoTransactions", "column": "left" },
        //          { "moduleId": "viewmodels/summaries/getPaymentBarChartYearly", "column": "right" }
    ...
    vm.canActivate = function () {
        ...
        if (collection.uty == "isCashier") {
            router.navigate("cashierAddEdit/0");
            return false;
